/**
 * 原始代码来自 bangbang(http://lmbtfy.cn/)，mengkun(https://mkblog.cn) 在原作的基础上作了一些小修改，以使用微软Bing搜索
                ...
                var interval = setInterval(function () {
                    ...
                    if (i > kw.length) {
                        ...
                        $arrow.animate({
                            ...
                            setTimeout(function () {
                                window.location = 'https://cn.bing.com/search?q=' + encodeURIComponent(kw);
                            }, 2000);
                        });
                    }
                }, 200);
